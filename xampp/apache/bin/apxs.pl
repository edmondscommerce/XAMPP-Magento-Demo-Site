...
my $installbuilddir = 'D:\RELEAS~1\APACHE~1\build';
...
my $CP    = 'C:\perl\bin\perl.EXE -MExtUtils::Command -e cp';
my $CHMOD = 'C:\perl\bin\perl.EXE -MExtUtils::Command -e chmod';
my $RM_F  = 'C:\perl\bin\perl.EXE -MExtUtils::Command -e rm_f';
my $TOUCH = 'C:\perl\bin\perl.EXE -MExtUtils::Command -e touch';
